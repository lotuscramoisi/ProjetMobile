    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <form class="form-inline d-flex">
            ...
            if (isset($_SESSION['login'])) {
                ...
                echo '<button type="button" class="btn btn-outline-success me-3" data-toggle="modal" data-target="#autorisation">';
                echo 'Autorisation';
                echo '</button>';
                echo '<button type="button" class="btn btn-outline-success me-3" data-toggle="modal" data-target="#signIn">';
                echo 'Sign in';
                echo '</button>';
                echo '<button type="button" class="btn btn-outline-success me-3" data-toggle="modal" data-target="#register">';
                echo 'Register';
                echo '</button>';
            }
            ?>
